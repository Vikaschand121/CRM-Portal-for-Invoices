...
export const PaymentDocumentSubTypePage = () => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const [docs, payment] = await Promise.all([
          documentsService.getDocumentsByPayment(parseInt(paymentId)),
              ...
              <Box sx={{
                ...
                <Box>
                  ...
                  <Typography variant="body1" sx={{ opacity: 0.9 }}>
                    {paymentInfo} • {documents.length} document{documents.length !== 1 ? 's' : ''}
                  </Typography>
                </Box>
              </Box>
...
export default PaymentDocumentSubTypePage;