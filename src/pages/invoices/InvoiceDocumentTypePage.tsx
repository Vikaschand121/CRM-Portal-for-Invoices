...
export const InvoiceDocumentTypePage = () => {
  const { companyId, propertyId, invoiceId, documentType } = useParams<{ companyId: string; propertyId: string; invoiceId: string; documentType: string }>();
...
export default InvoiceDocumentTypePage;