...
export const CompanyArchivedDocumentsPage = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Filter by companyId
        const companyDocs = archivedDocs.filter(doc => doc.companyId === parseInt(companyId));
    ...
    <Container maxWidth="xl">
      <Box sx={{
            ...
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Box>
                  ...
                  >
                    {companyName} Archived Documents
                  </Typography>
        ...
        {documentGroups.length === 0 ? (
          <Alert severity="info">
            No archived documents found for this company.
          </Alert>
        ) : (
          <Box
            sx={{
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                    <Button
                      ...
                      onClick={() => {
                        if (group.subType) {
                          navigate(`/companies/${companyId}/documents/archived/subtype/${encodeURIComponent(group.subType)}`);
                        } else {
                          navigate(`/companies/${companyId}/documents/archived/type/${encodeURIComponent(group.type)}`);
                        }
                      }}
                      variant="outlined"
                      size="small"
...
export default CompanyArchivedDocumentsPage;