...
export const PropertyDocumentSubTypePage = () => {
  const { companyId, propertyId, documentSubType } = useParams<{ companyId: string; propertyId: string; documentSubType: string }>();
...
export default PropertyDocumentSubTypePage;