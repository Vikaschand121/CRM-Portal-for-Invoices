...
export const PaymentDocumentsPage = () => {
  ...
  if (error) {
    return (
      <Container maxWidth="lg" sx={{ mt: 6 }}>
        ...
        <Button startIcon={<ArrowBack />} onClick={() => navigate(`/payments/${paymentId}`)}>
          Back to Payment
        </Button>
      </Container>
    );
    ...
    <Container maxWidth="xl">
      <Box sx={{
              ...
              <Box sx={{
                ...
                <Box>
                  ...
                  <Typography variant="body1" sx={{ opacity: 0.9 }}>
                    {paymentInfo} • {documents.length} total documents
                  </Typography>
                </Box>
              </Box>
        ...
        {documentGroups.length === 0 ? (
          <Alert severity="info">
            No documents found for this payment.
          </Alert>
        ) : (
          <Box
            sx={{
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                    <Button
                      ...
                      onClick={() => {
                        if (group.subType) {
                          navigate(`/payments/${paymentId}/documents/subtype/${encodeURIComponent(group.subType)}`);
                        } else {
                          navigate(`/payments/${paymentId}/documents/type/${encodeURIComponent(group.type)}`);
                        }
                      }}
                      variant="outlined"
                      size="small"
