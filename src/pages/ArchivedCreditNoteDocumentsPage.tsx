...
export const ArchivedCreditNoteDocumentsPage = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Filter by creditNoteId
        const creditNoteDocs = archivedDocs.filter(doc => doc.creditNoteId === parseInt(creditNoteId));
        setDocuments(creditNoteDocs);
    ...
    <Container maxWidth="xl">
      <Box sx={{
            ...
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Box>
                  ...
                  >
                    {creditNoteInfo} Archived Documents
                  </Typography>
        ...
        {documentGroups.length === 0 ? (
          <Alert severity="info">
            No archived documents found for this credit note.
          </Alert>
        ) : (
          <Box
            sx={{
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                    <Button
                      ...
                      onClick={() => {
                        if (group.subType) {
                          navigate(`/credit-notes/${creditNoteId}/documents/archived/subtype/${encodeURIComponent(group.subType)}`);
                        } else {
                          navigate(`/credit-notes/${creditNoteId}/documents/archived/type/${encodeURIComponent(group.type)}`);
                        }
                      }}
                      variant="outlined"
                      size="small"
...
export default ArchivedCreditNoteDocumentsPage;