  ...
  if (error) {
    return (
      <Container maxWidth="lg" sx={{ mt: 6 }}>
        ...
        <Button startIcon={<ArrowBack />} onClick={() => navigate(`/tenants/${tenantId}`)}>
          Back to Tenant
        </Button>
      </Container>
    );
          ...
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Button
                  startIcon={<History />}
                  onClick={() => navigate(`/documents/archived?tenantId=${tenantId}`)}
                  sx={{
                    mb: { xs: 0, md: 2 },
                    bgcolor: 'rgba(255, 255, 255, 0.2)',
                    color: 'white',
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                    <Button
                      ...
                      onClick={() => {
                        if (group.subType) {
                          navigate(`/tenants/${tenantId}/documents/subtype/${encodeURIComponent(group.subType)}`);
                        } else {
                          navigate(`/tenants/${tenantId}/documents/type/${encodeURIComponent(group.type)}`);
                        }
                      }}
                      variant="outlined"
                      size="small"
