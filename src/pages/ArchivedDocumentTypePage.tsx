...
export const ArchivedDocumentTypePage = () => {
  const { companyId, documentType } = useParams<{ companyId: string; documentType: string }>();
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Filter by companyId and type
        const companyDocs = archivedDocs.filter(doc => doc.companyId === parseInt(companyId) && doc.documentType === decodedType);
            ...
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Box>
                  ...
                  >
                    Archived {decodeURIComponent(documentType || '')}
                  </Typography>
...
export default ArchivedDocumentTypePage;