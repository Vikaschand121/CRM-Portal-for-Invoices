...
export const PropertyDocumentsPage = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        setPropertyName(property?.propertyName || 'Property');
      } catch (err) {
          ...
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Button
                  startIcon={<History />}
                  onClick={() => navigate(`/companies/${companyId}/properties/${propertyId}/documents/archived`)}
                  sx={{
                    mb: { xs: 0, md: 2 },
                    bgcolor: 'rgba(255, 255, 255, 0.2)',
                    color: 'white',
                ...
                <Button
                  startIcon={<ArrowBack />}
                  onClick={() => navigate(`/companies/${companyId}/properties/${propertyId}`)}
                  sx={{
                    mb: { xs: 0, md: 2 },
                    bgcolor: 'rgba(255, 255, 255, 0.2)',
                    color: 'white',
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                    <Button
                      ...
                      onClick={() => {
                        if (group.subType) {
                          navigate(`/companies/${companyId}/properties/${propertyId}/documents/subtype/${encodeURIComponent(group.subType)}`);
                        } else {
                          navigate(`/companies/${companyId}/properties/${propertyId}/documents/type/${encodeURIComponent(group.type)}`);
                        }
                      }}
                      variant="outlined"
                      size="small"
