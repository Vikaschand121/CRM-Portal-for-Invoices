...
export const ArchivedPaymentDocumentTypePage = () => {
  const { paymentId, documentType } = useParams<{ paymentId: string; documentType: string }>();
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Filter by paymentDetailId and documentType
        const typeDocs = archivedDocs.filter(doc => doc.paymentDetailId === parseInt(paymentId) && doc.documentType === decodedType);
...
export default ArchivedPaymentDocumentTypePage;